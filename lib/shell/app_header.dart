      ...
      child: Row(
        children: [
          ...
          SupportAuthorButton(
            subtitle: isLoading
                ? '知识库加载中'
                : '${knowledge.issues.length} fixes · ${knowledge.materials.length} materials',
          ),
        ],
      ),
    );
...
class SupportAuthorButton extends StatelessWidget {
  const SupportAuthorButton({super.key, required this.subtitle});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                '如果这个工具帮你少废了一卷料，可以随手支持一下。感谢每一次真实使用和反馈。',
                style: TextStyle(
                  fontSize: 13,
                  height: 1.5,
